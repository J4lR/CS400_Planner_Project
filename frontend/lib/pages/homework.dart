...
class _HomeworkPageState extends State<HomeworkPage> {
  ...
  Future<void> _loadTasks() async {
    ...
    final tasks = await getTasks(category: 'homework');
    setState(() {
      _tasks = tasks;
      _isLoading = false;
    });
          ...
          : _tasks.isEmpty
              ? Center(
                  child: Column(
                    ...
                    children: [
                      Icon(Icons.school_outlined, size: 64, color: isDark ? const Color(0xFF8B949E) : const Color(0xFF6B7280)),
                      const SizedBox(height: 16),
                      Text('No homework yet!', style: TextStyle(fontSize: 18, fontWeight: FontWeight.w600, color: isDark ? Colors.white : const Color(0xFF1F2937))),
                      const SizedBox(height: 8),
                      Text('Tap + to add homework', style: TextStyle(fontSize: 14, color: isDark ? const Color(0xFF8B949E) : const Color(0xFF6B7280))),
                    ],
                  ),
                )
              : RefreshIndicator(
