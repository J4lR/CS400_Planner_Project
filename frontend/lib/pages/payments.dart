...
class _PaymentsPageState extends State<PaymentsPage> {
  ...
  Future<void> _loadTasks() async {
    ...
    final tasks = await getTasks(category: 'payment');
          ...
          : _tasks.isEmpty
              ? Center(
                  child: Column(
                    ...
                    children: [
                      Icon(Icons.payments_outlined, size: 64, color: isDark ? const Color(0xFF8B949E) : const Color(0xFF6B7280)),
                      const SizedBox(height: 16),
                      Text('No payments yet!', style: TextStyle(fontSize: 18, fontWeight: FontWeight.w600, color: isDark ? Colors.white : const Color(0xFF1F2937))),
                      const SizedBox(height: 8),
                      Text('Tap + to add a payment', style: TextStyle(fontSize: 14, color: isDark ? const Color(0xFF8B949E) : const Color(0xFF6B7280))),
                    ],
                  ),
                )
              : RefreshIndicator(
                          ...
                          subtitle: Row(
                            children: [
                              ...
                              if (task['repeats'] == true) ...[
                                ...
                                const Icon(Icons.repeat, size: 12, color: Color(0xFF22C55E)),
                                const SizedBox(width: 4),
                                const Text('Recurring', style: TextStyle(fontSize: 11, color: Color(0xFF22C55E))),
                              ],
                            ],
                          ),
